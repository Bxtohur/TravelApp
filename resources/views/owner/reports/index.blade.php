<x-app-layout>
    ...
    <style>
        @media print {
            ...
            /* Munculkan hanya area laporan */
            .py-12, .py-12 * {
                visibility: visible;
            }
            /* Posisikan laporan di pojok kiri atas kertas */
            .py-12 {
                position: absolute;
                left: 0;
                top: 0;
            ...
            /* Helper class buat ngumpetin elemen saat print */
            .print\:hidden {
                display: none !important;
            }
            /* Helper class buat munculin elemen saat print */
            .print\:block {
            ...
            /* Reset background biar hemat tinta dan bersih */
            body {
